...
plot\
"./data2.csv" using 1:2 title "Type A" ps 1.7 pt 4 lc "black",\
"./data2.csv" using 1:3 title "Type B" ps 1.7 pt 6 lc "black"
...
#x, y軸ラベルを書き込む
set ylabel "Equation $k = px$"
set xlabel "The size of a graph"
